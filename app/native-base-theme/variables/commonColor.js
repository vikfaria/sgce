...
export default {
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === "ios" ? "#455a64" : "#3F51B5",
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === "ios" ? "#ffffff" : "#bfc6ea",
  ...
  // Header
  toolbarBtnColor: platform === "ios" ? "#ffffff" : "#fff",
  toolbarDefaultBg: platform === "ios" ? "#455a64" : "#3F51B5",
